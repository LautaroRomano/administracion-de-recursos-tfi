...
import { getInteracciones } from "@/actions/interacciones.action";

const initDataState: InteractionsHistoryType[] = [];
...
export const Interacciones = () => {
  ...
  const getData = async () => {
    ...
    const res = await getInteracciones(startDate, endDate);
    if (res.error) {
